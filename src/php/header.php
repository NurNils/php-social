      ...
      <div class="btn-group">
        <button type="button" class="btn btn-info notifications" data-toggle="dropdown" onclick="openNotifications()" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="notifications-wrapper">
            ' . (count($notificationsArray) > 0 ? '<div class="new-notifications"><span class="new-notifications-nr">' . count($notificationsArray) . '</span></div>' : '') . '
          </div>
        </button>
        <div class="dropdown-menu notifications-dropdown"> ' . $notifications . ' </div>
      </div>
