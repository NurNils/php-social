    ...
    if ($this->deleted) {
        ...
        '">
                ...
                <div class="card-body post-content">
                    <h5 class="card-title post-headline">
                        ...
                        <span class="card-subtitle mb-2 text-muted post-date">· &nbsp;' .
        prettyTime($this->postDate) .
        '</span>
                    </h5>
      ...
      $html =
        ...
        '">
                  <img src="' .
        $this->user->getAvatar() .
        '" class="posted-profile-pic"/>
                </a>
                <div class="card-body post-content">
                    <h5 class="card-title post-headline">
                        <a class="post-username"  href="profile.php?user=' .
        $this->user->name .
        '">' .
        $this->user->name .
        '</a> 
        ...
        (($_SESSION['user']->verified || $_SESSION['user']->id == $this->user->id) && $actions
          ? '<span class="material-icons delete-post text-danger" onclick="deletePost(' .
            $this->id .
            ')">delete</span>'
          : '') .
        '
        ...
        '
                    ' .
        ($actions
          ? '<span onclick="feedback(1, ' .
            $this->id .
            ')" id="like-btn' .
            $this->id .
            '" class="material-icons feedback text-primary ' .
            ($this->liked == '1' ? 'text-success' : '') .
            '">thumb_up</span>
                    <span class="like-count text-primary" id="like-count' .
            $this->id .
            '">' .
            $this->likecount .
            '</span>
                    <span onclick="feedback(0, ' .
            $this->id .
            ')" id="dislike-btn' .
            $this->id .
            '" class="text-primary material-icons feedback ' .
            ($this->liked == '0' && !is_null($this->liked) ? 'text-danger' : '') .
            '">thumb_down</span>
                    <div class="reply">
                        <a href="post.php?refPost=' .
            $this->id .
            '" class="material-icons text-success reply-icon">reply</a>
                        <span class="reply-count text-success">' .
            $this->replycount .
            '</span>
                    </div>'
          : '') .
