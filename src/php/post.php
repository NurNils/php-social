...
class Post {
    ...
    function getHtml() {
        ...
        <div class="card post" id="post'.$this->id.'">
            ...
            <div class="card-body post-content">
                ...
                <span onclick="feedback(0, '.$_SESSION['user']->id.', '.$this->id.')" id="dislike-btn'.$this->id.'" class="text-primary material-icons feedback '.($this->liked == "0" ? 'text-danger' : '').'">thumb_down</span>
                <div class="reply">
    ...
    function getContent() {
        ...
        if(isset($this->content) && $this->content != "") {
            $changedContent = preg_replace('/(?<= |^)(#[a-zA-Z0-9]+)(?= |$)/', '<span class="hashtag" onclick="search(\'$1\')">$1</span>', $this->content);
